...
f_meta=f'{prj}/a00_raw/meta/cell_methlater.json'
l_cell=['Marginal', 'Intermediate', 'Basal', 'Spindle', 'Root', 'Reissner', 'Fibrocyte', 'Macrophage']

d_order={
'sys_stero__ctrl_down': [0, 1, 2, 3],
'sys_stero__ctrl_up': [3, 2,0, 1],
'tt_stero__ctrl_down': [2,3,0,1],
'tt_stero__ctrl_up': [2,3,0,1],
'tt_stero__sys_stero_down': [3,1,2,0],
'tt_stero__sys_stero_up': [0,1,2,3]
}
